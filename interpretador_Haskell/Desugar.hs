...
desugar expr = case expr of
  ...
  -- IndS num       -> IndC num
  -- intListS e1 e2 -> ConsC (desugar e1) (desugar e2)
  -- codeListS codeList -> codeListC codeList
  LetS name val body ->
    AppC
  ...
  CaseS num intlist codelist -> CaseC (desugar num) (desugar intlist) (desugar codelist)
